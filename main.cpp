...
public:
    MainApp()
    {
        ...
        cout << "\n\tEnter the name of the input file (without extension): ";
        getline(cin, fname);

        input_file.open(fname + ".txt");
    ...
    void ModuleOne(string name)
    {
        ...
        string storage_output = "";

        cout << "\n\tEnter the name of the output file (without extension): ";
        getline(cin, storage_output);

        output_file.open(storage_output + ".txt");
